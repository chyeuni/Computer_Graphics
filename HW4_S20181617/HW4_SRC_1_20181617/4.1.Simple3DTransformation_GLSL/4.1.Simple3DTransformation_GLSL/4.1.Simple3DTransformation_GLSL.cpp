...
void display(void) {
	...
	for (int i = 0; i <= 360; i += 45) {
		float angle = (float)i;
		ModelViewProjectionMatrix = glm::translate(ViewMatrix, glm::vec3(2 * sinf((angle - 180) * TO_RADIAN), 0.0f, (angle - 180) * TO_RADIAN));
		ModelViewProjectionMatrix = glm::rotate(ModelViewProjectionMatrix, (-90) * TO_RADIAN, glm::vec3(0.0f, 1.0f, 0.0f));
